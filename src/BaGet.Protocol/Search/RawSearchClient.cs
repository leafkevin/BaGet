...
public class RawSearchClient : ISearchClient
{
    ...
    public async Task<SearchResponse> SearchAsync(string query = null, int skip = 0,
    ...
    internal static string AddSearchQueryString(string uri, string query,
        int? skip, int? take, bool includePrerelease, bool includeSemVer2, string queryParamName)
    {
